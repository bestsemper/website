        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="flex items-center gap-4">
              <button
                onClick={toggleTheme}
                className="transition-colors hover:opacity-70 cursor-pointer text-foreground-secondary"
              ...
              <a
                ...
                className="transition-colors hover:opacity-70 text-foreground-secondary"
              >
