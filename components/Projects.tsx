  ...
  return (
    <section id="projects" className="py-24 px-6 bg-white">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-16">Projects</h2>
            ...
            <div key={index} className="border-b border-gray-200 pb-12 last:border-0">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {project.technologies.map((tech, idx) => (
                  <span 
                    key={idx} 
                    className="px-3 py-1 bg-gray-100 text-gray-700 text-sm border border-gray-200 rounded-md"
                  >
                    {tech}
                  </span>
                ))}
